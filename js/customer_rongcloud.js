...
RongIMClient.connect(token, {
    onSuccess: function (userId) {
        ...
        console.log("Login successfully." + userId + name);
    ...
    onReceived: function (message) {
        ...
        switch (message.messageType) {
            case RongIMClient.MessageType.TextMessage:
                ...
                var ans =
                    '<div class="answer"><div class="heard_img left"><img src="img/member.png"></div>';
...
$(document).ready(function () {
    ...
    var targetId = "001"; // 想获取自己和谁的历史消息，targetId 赋值为对方的 Id。
    ...
    RongIMLib.RongIMClient.getInstance().getHistoryMessages(conversationType, targetId, timestrap, count, {
        onSuccess: function (list, hasMsg) {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                //  console.log(chat);
                if (userid == 001) { //判断是否为账号id
                     $('#newsList').append('<div class="answer"><div class="heard_img left"><img src="img/member.png"></div>' + '<div class="answer_text"><p>' + Emoji.trans(chat) + '</p>' + '<i></i>' + '</div></div>');
                     for_lastest();
